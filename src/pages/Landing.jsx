...
const Landing = () => {
    return (
        <div className="w-full h-full md:p-8 flex items-center justify-center">
            <div className="relative w-full max-w-[1400px] h-full md:h-[80vh] bg-white/30 dark:bg-[#101614]/40 backdrop-blur-2xl rounded-[2.5rem] md:rounded-[3.5rem] border border-white/50 dark:border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.05)] overflow-hidden flex flex-col md:flex-row ring-1 ring-white/20">
                <div className="flex-1 flex flex-col justify-center px-8 md:px-20 py-12 relative z-20">
                    <div className="flex flex-col gap-6 md:gap-8 max-w-2xl">
                        ...
                        <div className="mt-8 pt-8 border-t border-[#1d2624]/5 dark:border-white/5 flex gap-8">
                            <div className="flex flex-col gap-1">
                                <span className="text-xs font-bold uppercase tracking-wider text-[#1d2624]/40 dark:text-white/40">Active Tasks</span>
                                <span className="text-lg font-bold text-[#1d2624] dark:text-white">12</span>
                            </div>
                            <div className="flex flex-col gap-1">
                                <span className="text-xs font-bold uppercase tracking-wider text-[#1d2624]/40 dark:text-white/40">Next Meeting</span>
                                <span className="text-lg font-bold text-[#1d2624] dark:text-white">10:00 AM</span>
                            </div>
                        </div>
                    </div>
                </div>
