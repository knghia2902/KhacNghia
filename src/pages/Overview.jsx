    ...
    return (
        <>
            <nav className="hidden md:flex flex-col w-64 border-r border-white/20 dark:border-white/5 py-8 px-6 gap-2 shrink-0">
                ...
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/50 dark:bg-white/10 border border-white/40 dark:border-white/5 shadow-sm text-primary-dark dark:text-primary font-bold cursor-pointer" href="#">
                    <span className="material-symbols-outlined">dashboard</span>
                    <span>Overview</span>
                </a>
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/30 dark:hover:bg-white/5 transition-colors text-[#1d2624]/70 dark:text-white/70 font-medium cursor-pointer" href="#">
                ...
                <div className="mt-auto">
                    <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-all text-[#1d2624] dark:text-white font-bold cursor-pointer" href="#">
