...
const Layout = ({ children }) => {
    return (
        <div className="relative w-screen h-screen overflow-hidden bg-background-light dark:bg-background-dark text-[#1d2624] dark:text-white font-display selection:bg-primary/30">
            ...
            <main className="relative z-10 flex items-center justify-center h-full w-full pt-20 pb-[80px]">
                <div className="relative w-full max-w-[1400px] h-full frosted-glass rounded-[2.5rem] md:rounded-[3rem] border border-white/40 dark:border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.05)] overflow-hidden flex flex-row">
                    {children}
                </div>
            </main>
