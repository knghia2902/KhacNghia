    ...
    return (
        <div className="flex items-center justify-end gap-2 flex-wrap text-xs">
            ...
            <div className="relative w-48 sm:w-56 md:w-64">
                <span className="material-symbols-outlined absolute left-2.5 top-1/2 -translate-y-1/2 text-[#1d2624]/40 dark:text-white/40 text-[15px] pointer-events-none">
                    search
                </span>
                <input
                    ref={inputRef}
                    ...
                    className="w-full h-7 pl-7 pr-14 bg-white/40 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-xs text-[#1d2624] dark:text-white placeholder:text-[#1d2624]/40 dark:placeholder:text-white/40 focus:outline-none focus:ring-1 focus:ring-primary transition-all"
                />
